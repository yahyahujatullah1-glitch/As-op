...
export const metadata: Metadata = {
  ...
  description: "Join the AS OP Gaming Community.",
};

export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${orbitron.variable} ${inter.variable} ${rajdhani.variable}`}>
      <body className="font-inter antialiased bg-[#050714] text-white overflow-x-hidden">
        
        {/* Sticky Navbar */}
        <nav className="fixed top-0 left-0 w-full z-50 border-b border-white/5 bg-[#050714]/90 backdrop-blur-md">
          <div className="max-w-[1280px] mx-auto px-6 h-20 flex items-center justify-between">
            <div className="flex items-center gap-3 cursor-pointer">
              <img src="https://i.ibb.co/CpCfYw2c/AS-OP-Channel-Logo-removebg-preview.png" alt="AS OP Logo" className="h-10 w-auto" />
            ...
            <div className="flex items-center gap-4">
              ...
              <button className="h-10 px-6 items-center justify-center rounded bg-gradient-to-r from-primary to-red-800 hover:brightness-110 text-white text-sm font-bold font-rajdhani tracking-wide transition-all shadow-[0_0_15px_rgba(220,38,38,0.4)]">
                  JOIN NOW
              </button>
            </div>
          </div>
